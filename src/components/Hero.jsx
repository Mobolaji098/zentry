...
setIsLoading(false);
    ...
    return (
        <div className='relative h-dvh w-screen overflow-x-hidden'>
            {isLoading && <div className='absolute z-[100] bg-violet-50 w-screen h-dvh flex-center'>
            ...
            <div id='video-frame' className="z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75">
                <div>
                    <div
                ...
                <div className='absolute top-0 left-0 z-40 size-full'>
                    <div className='mt-24 px-5 sm:px-10 '>
                        ...
                        <p className='max-w-64 mb-5 font-robert-regular text-blue-100'>Enter the Metagame
